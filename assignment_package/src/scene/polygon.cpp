...
Polygon2D::Polygon2D(GLWidget277 *context)
    : Drawable(context), m_vertPos(), m_vertIdx(), m_numVertices(0)
{}

Polygon2D::Polygon2D(GLWidget277 *context, int numSides)
...
Polygon2D::Polygon2D(GLWidget277 *context, const std::vector<glm::vec3> &positions)
